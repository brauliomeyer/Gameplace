...
<div id="container">
    <div class="panel-body">
        <div class="row details">
            ...
            <form method="post" action="<?php base_url(); ?>cart/add/<?php echo $product->id; ?>">
                Qty: <input class="qty" type="text" name="qty" value="1"> <br>
				<input type="hidden" name="item_number" value="<?php $product->id; ?>">
    ...
    <button type="reset" name="reset_submit" class="btn btn-primary">Cancel</button>
				        </form>
				    </div>
            </div>
        </div>
